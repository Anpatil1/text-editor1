...
def about():
    showinfo("About ANPText","This is a text editor built using Tkinter\nDeveloped by Avadhut Nangare Patil\nGithub:https://github.com/Anpatil1")
def exitapplication():
    root.quit()
def selectall():
    global textarea
...
submenu2.add_command(label="Redo        Ctrl+E",command=redofunc)
